            ...
            getIntradayData(authToken, 'heart')
                .then(function(hrData) {
                    ...
                    for(var stepObj in stepData["activities-steps-intraday"].dataset) {
                        console.log("step obj: " + JSON.stringify(stepData[stepObj])); 
                        ...
                        for(var hrObj in hrData["activities-heart-intraday"].dataset) {
                            console.log("hr obj: " + JSON.stringify(hrData[hrObj]));
                            if (hrData[hrObj].time === stepData[stepObj].time) {
                                data[stepObj].hr = hrData[hrObj].value;
